 ...
 * @method \Illuminate\Http\Client\Response mediaDownload(string $id, ?string $ext = null)
 * @method \Illuminate\Http\Client\Response saveMediaLocal(string $id, string $ext)
